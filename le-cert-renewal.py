...
# To remove this file, run: sudo rm /opt/bitnami/lightsail/scripts/le-cert-renewal.py
...
def main():
    ...
    if len(argv) == 1:
        log_info("usage: sudo <python/python3> le-cert-renewal.py <target_cert_name>")
